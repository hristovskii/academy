    ...
    return(
        <section className="my-10 md:mx-28 mx-12">
            ...
            <div className="lg:flex justify-evenly items-center gap-14">
                ...
                <Image src={img1} alt="Sponsor Logo" height={300} style={{ borderRadius: "50%", }} className="mt-8 mb-8"></Image>
                ...
                <div className="text-eestec text-center items-center" >
                <Image src={img2} alt="Sponsor Logo" height={300} style={{ borderRadius: "50%", }} className="mt-8 mb-8"></Image>
                ...
                <div className="text-eestec text-center items-center" >
                <Image src={img3} alt="Sponsor Logo" height={300} style={{ borderRadius: "50%", }} className="mt-8 mb-8"></Image>
            ...
            <div className="lg:flex justify-evenly items-center">
                <div className="text-eestec text-center items-center" >
                <Image src={img4} alt="Sponsor Logo" height={300} style={{ borderRadius: "50%", }} className="mt-8 mb-8"></Image>
                ...
                <div className="text-eestec text-center items-center" >
                <Image src={img5} alt="Sponsor Logo" height={300} style={{ borderRadius: "50%", }} className="mt-8 mb-8"></Image>
